...
export function AdminSettings() {
  ...
  const [primaryColor, setPrimaryColor] = useState(theme.colors?.primary ?? '#000000');
        ...
        <Card className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InputField
              label="Platform Name"
              value={platformName}
              onChange={(e: ChangeEvent<HTMLInputElement>) => setPlatformName(e.target.value)}
            ...
            <div className="w-full mb-5">
              ...
              <select
                value={themeMode}
                onChange={(e: ChangeEvent<HTMLSelectElement>) => setThemeMode(e.target.value)}
        ...
        <Card className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InputField
              ...
              type="number"
              value={derivAppId}
              onChange={(e: ChangeEvent<HTMLInputElement>) => setDerivAppId(e.target.value)}
